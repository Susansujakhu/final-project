...
class Interface(tk.Frame):
    ...
    def tkraise(self):
        ...
        # Hospitall name
        ttk.Label(self, text="Add Patient", font= ('Algerian', 25, BOLD),background = 'black', foreground = 'white').place(relx = 0.15, rely =0.04)
        self.makeWidgets()
    ...
    def makeWidgets(self):
        ...
        #Back Button        
        back_image = Image.open("backWhite.png")
        ...
        back_btn.place(relx = relX - 0.08, rely = P_relY - 0.12, width=27, height=22)
        back_btn.image = back   
